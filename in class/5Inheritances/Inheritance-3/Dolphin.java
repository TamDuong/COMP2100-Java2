...
/**
 * Because Dolphin is a concrete (non-abstract) subclass of Animal,
 * it must override any abstract methods inherited from Animal.  In this
 * case we have only one such method, move().  Dolphin defines move()
 * to simply call its existing swim() method.
 * 
 * @author Top Malasri
 * @version Feb. 24, 2014
 */
